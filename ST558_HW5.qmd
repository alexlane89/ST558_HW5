...
> Summary - a warning that this result also appears to include the entire underlying function code, which is far too much information, but I need the summary information included in the latter 25% of this output to evaluate models.

```{r}
summary(treeFit1, verbose = FALSE)
```
